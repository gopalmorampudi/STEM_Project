					...
					<div class="col-md-6">
						...
						<form class="form-light mt-20" action="insert_data.php?action=insert_tutor_reg" method="post" role="form" onsubmit="return tutorRegistrationFormValidation();">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="instructorID" name="instructorID" placeholder="Enter Your Instructor ID" onkeypress="noneErrors(instructorID,instructorIDError);">
								<span id="instructorIDError" style="color:red;"></span>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label>Email ID</label>
										<input type="email" name="emailid" id="emailId" class="form-control" placeholder="Enter Email ID" onblur="emailExistsOrNot();" onkeypress="noneErrors(emailId,email2Error);">
                             ...
                             <div class="form-group">
								...
								<input type="text" name="phone_number" id="phoneNumber" class="form-control" placeholder="Enter Your Phone Number" onkeypress="noneErrors(phoneNumber,phoneError);">
...
<script>
		function tutorRegistrationFormValidation(){
			...
			for(var i=0;i<weekChecks.length;i++){
			 ...
			 if(username=='' || instructorID=='' || password=='' || confPassword=='' || emailId=='' || phoneNumber==''|| wh==''){
				if(username==''){
					
					document.getElementById('instructorIDError').innerHTML='Please fill user name field';
				}
				if(instructorID==''){
					
					document.getElementById('tutorNameError').innerHTML='Please fill instructor id field';
				}
				if(emailId==''){
