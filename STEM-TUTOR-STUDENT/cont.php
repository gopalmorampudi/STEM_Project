...
<div id='fg_formContainer'>
    <div id="fg_container_header">
        ...
        <div id="fg_box_Close"><a href="javascript:fg_hideform('fg_formContainer','fg_backgroundpopup');">  X</a></div>
    </div>
   ...
   <!-- <input type='text'  class='spmhidip' name='echo $formproc->GetSpamTrapInputName(); ?>' />-->
    <div class='short_explanation'></div>
    <div id='fg_server_errors' class='error'></div>
    <div class='container'>
        <p>THIS IS A POP UP MENU>>>>>>>>>>>>>>>></P>    </div>
    <div class='container'>
