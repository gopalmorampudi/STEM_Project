				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						onsubmit="return loginFormValidations();">
							...
							<button type="submit" name="action" value="student_login" class="btn btn-two">Sign In</button><p><br/></p>
						</form>
					</div>
				</div>
			</div>
...
function checkFlag(){
	...
	if(flag=='success'){
		document.getElementById('title_log').innerHTML="<font color='green'>You have registred successfully</font>";
	}else if(flag=='loginFailed'){
		document.getElementById('title_log').innerHTML="<font color='red'>Please check, your email id or password might bewrong</font>";
	}
