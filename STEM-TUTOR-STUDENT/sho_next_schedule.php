  ...
  ?>
		...
		<?php
				foreach($records as $r){
					...
					?>
					;cursor:pointer;"
					onclick="<?=($countRec=='Preferred')?'':'fixSchedule(this,date'.$i.',day'.$i.');'?>">
...
<a href="show_next_schedule.php?date=<?=date('Y-m-d', mktime(0, 0, 0, date('m'), date('d') +$diffDay , date('Y')));?>">next></a>
<?php
...
<a href="test.php">&lt;previous</a>
<a href="show_next_schedule.php?date=<?=date('Y-m-d', mktime(0, 0, 0, date('m')+$diffMonth, date('d') + $diffDay , date('Y')));?>">next></a>
<?php
...
<a href="test.php">&lt;previous</a>
<a href="show_next_schedule.php?date=<?=date('Y-m-d', mktime(0, 0, 0, date('m')+$diffMonth, date('d') + $diffDay , date('Y')+$diffYear));?>">next></a>
<?php
}
?>
<script>
