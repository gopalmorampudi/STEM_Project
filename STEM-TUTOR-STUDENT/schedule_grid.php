...
<!--border style="border-collapse:collapse;" cellpadding="10"-->
<tr class="danger">
<th>Date\Time<br></th>
<th>8:00AM</th>
<th>9:00AM</th>
...
where tsc.tutor_id=$user and tsc.date_selected='$currentDate' and tsc.subject_id=s.subject_id and st.emailid=tsc.student_email and tsc.`status`='schedule';";
...
//print_r($records);echo '<br/><br/><br/><br/>';
?>
...
for($j=0;$j<sizeof($timeArray);$j++){
	...
	<?php
		...
		?>
			...
			<?php //echo 'Subject : <b>'.$records[$k][2].'</b><br/>'.'Student Name : <b>'.$records[$k][1].'</b>';?>
