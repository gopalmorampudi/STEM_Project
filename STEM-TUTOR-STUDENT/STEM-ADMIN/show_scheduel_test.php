...
include "dbconnection.php";
 ...
 for($i=$weekDayCount;$i>=1;$i--){
	 ...
	 $sql="select * from `schedule` sc where sc.date_col='$dateOnly' and sc.fperiod='AM';";
	...
	array_push($records,$record);
	 ...
	 // $sql1="select * from `schedule` sc where sc.date_col='$dateOnly' and sc.fperiod='PM'";
 $sql1="select * from `schedule` sc where sc.date_col='$dateOnly' and sc.fperiod='PM'";
...
<a href="show_next_schedule.php?date=<?=date('Y-m-d', mktime(0, 0, 0, date('m'), date('d') +$diffDay , date('Y')));?>" style="float:right;" class="btn btn-primary">next></a>