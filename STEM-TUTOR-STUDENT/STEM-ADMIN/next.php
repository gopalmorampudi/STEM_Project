...
<a href="make_schedule.php" style="float:left;" class="btn btn-primary">previous</a>
<a href="make_next_schedule.php?date=<?=date('Y-m-d', mktime(0, 0, 0, date('m')+$diffMonth, date('d') +$diffDay , date('Y')+$diffYear));?>" style="float:right;" class="btn btn-primary">next></a>
<?php
}
?>