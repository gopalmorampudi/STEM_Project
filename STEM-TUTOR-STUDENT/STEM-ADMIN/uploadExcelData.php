...
<li class="treeview active">
  <a href="#">
<span>Excel Sheet Data</span><i class="fa fa-angle-left pull-right  text-green"></i>
  </a>
  <ul class="treeview-menu">
  <li>
...
<h3 class="box-title"> 
<a></i><b>Upload Excel Sheet</b></a>
</h3>
</div>
<form role="form" action="import.php" method="post" enctype="multipart/form-data">
<div class="box-body">
	<?php
if(isset($_SESSION['res'])=="unknown")
{
?>
<span style="color:green;">Upload CSV File only.</span>
<?php
unset($_SESSION['res']);
}
?>
<?php
if(isset($_SESSION['res1'])=="fail")
{
?>
<span style="color:green;">No New Data Uploaded.</span>
<?php
unset($_SESSION['res1']);
}
?>
...
<button type="submit" name="Import" value="Import" class="btn btn-primary">Upload file</button>
  </div>
</form>
  </div>
</div>
