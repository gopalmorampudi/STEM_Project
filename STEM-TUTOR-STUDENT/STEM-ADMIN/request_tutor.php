...
<td>
<form action="tutorOperations.php" method="post">
<input type="hidden" name="tutor_id" value="<?=$rs['tutor_id'] ?>">
<input type="hidden" name="tutor_name" value="<?=$rs['tutor_name'] ?>">
<input type="hidden" name="emailid" value="<?=$rs['emailid'] ?>">
...
<td></td>
<td>
<h4><b>No New Tutor Request Available here</b></h4>
</td>
<td></td>
<td></td>
</tr>
