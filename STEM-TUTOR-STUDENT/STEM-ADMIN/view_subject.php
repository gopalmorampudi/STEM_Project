...
<h1></i>
Courses 
<small>Detailes table</small>
</h1>
<ol class="breadcrumb">
<li><a href="#"></i>Courses </a></li>
</ol>
</section>
...
<tbody>
<?php
$sql="select * from subject s, departments d where s.dept_id=d.dept_id";
$res=mysql_query($sql);
if(mysql_num_rows($res)>0){
$brdarray=array();
while($subres=mysql_fetch_assoc($res)) {
$subjectarray[] = $subres;
}
...
<td>
<a href="edit_subject.php?subject_id=<?=$subject['subject_id']?>" class="btn btn-primary">Edit</a>
<a href="subjectOperation.php?action=Subdelete&subject_id=<?=$subject['subject_id']?>" class="btn btn-primary">Delete</a>
</td>
</tr>
<?php
}
...
<td></td>
<td>
<h4><b>No Subjects Available here</b></h4>
</td>
<td></td>
</tr>
<?php
