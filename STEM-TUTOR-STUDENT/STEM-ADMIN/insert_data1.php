...
header('Location: add_department.php?mesg=fail');
}
}
...
$admin_user=$_SESSION['adminuser'];
 ...
 //$replied_by=$_SESSION['adminuser'];
   // $query="insert into contact(customer_name,email,phone,description)values('$customer_name','$email','$phone','$description')"; 
...
// echo "secces";
header("Location: view_complaint.php?res=secces");
}else
{
	// echo "fail";
