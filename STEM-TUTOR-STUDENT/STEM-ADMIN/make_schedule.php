...
<li class="active"><a href="view_dept.php">
...
<ol class="breadcrumb">
<li><a href="#"></i>Make schedule </a></li>
</ol>
</section>
...
if(isset($_SESSION['flag'])){
	...
	echo "<h3 style='color:green'>Schedule Submitted</h3>";
	}else{
		echo "<h3 style='color:red'>Schedule not Submitted</h3>";
	}
}
?>
</h1>
...
<strong>All &copy; rights reserved by <a href="http://smartmindsteam.com">Desi Handlooms</a> 2015.</strong>
</footer>
