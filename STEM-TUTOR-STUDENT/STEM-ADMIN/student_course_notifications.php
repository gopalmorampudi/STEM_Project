...
<tbody>
<?php
$sql="select cn.option_type,cn.content,st.student_name from course_notifications cn, student st where cn.student_id=st.student_id";
$res=mysql_query($sql);
...
<td>
<?php
if($rs['option_type']=="courseNotExists")
{
	echo 'Course not exists';
}else{
	echo 'Course coverage limited';
}
	?>
