...
<tbody>
<?php
$sql="select * from tutor where status='pending'";
...
<!--<td>
	<a href="insert_data1.php?action=accept_tutor&tutor_id=<?=$tutor['tutor_id']?>" class="btn btn-primary">Accept</a>
	<a href="insert_data1.php?action=reject_tutor&tutor_id=<?=$tutor['tutor_id']?>" class="btn btn-primary">Reject</a>
</td>-->
</tr>
<?php
}
